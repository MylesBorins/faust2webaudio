...
class Noise : public dsp {
  ...
  public:
	...
	virtual void instanceInit(int samplingFreq) {
		...
		for (int i=0; i<256; i++) fVec25[i] = 0;
		...
		for (int i=0; i<128; i++) fVec45[i] = 0;
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalSlider("level", &fslider4, 0.0f, 0.0f, 6.0f, 1.0f);
		interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			iVec3[0] = iSlow6;
			iRec19[0] = ((iTemp1)?0:(iRec19[1] + abs((iSlow6 - iVec3[1]))));
			ftbl2[((int((iVec0[0] & ((iRec19[0] > 0) | iSlow7))))?iRec4[0]:15)] = iSlow6;
			float fTemp8 = powf(10,(0.05f * (ftbl2[iRec4[0]] - 6)));
			iRec20[0] = (12345 + (1103515245 * iRec20[1]));
			float fTemp9 = (fTemp8 * iRec20[0]);
			iVec4[0] = iSlow8;
			iRec22[0] = ((iTemp1)?0:(iRec22[1] + abs((iSlow8 - iVec4[1]))));
			ftbl3[((int((iVec0[0] & ((iRec22[0] > 0) | iSlow9))))?iRec4[0]:15)] = iSlow8;
			float fTemp10 = ftbl3[iRec4[0]];
			int iTemp11 = (fabsf((fTemp10 - 11)) < 0.5f);
			iVec5[0] = iTemp11;
			fRec21[0] = ((fRec21[1] + ((iVec5[0] - iVec5[1]) > 0.0f)) - (0.01186510500229472f * (fRec21[1] > 0.0f)));
			fVec6[IOTA&127] = ((0.498352519415873f * ((fTemp6 * fRec17[1]) + (fTemp7 * fRec17[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec21[0] > 0.0f))));
			...
			float fTemp12 = ftbl4[iRec4[0]];
			int iTemp13 = (fabsf((fTemp12 - 11)) < 0.5f);
			iVec8[0] = iTemp13;
			fRec24[0] = ((fRec24[1] + ((iVec8[0] - iVec8[1]) > 0.0f)) - (0.02373021000458944f * (fRec24[1] > 0.0f)));
			fVec9[IOTA&63] = ((0.4991755800396655f * ((fTemp6 * fRec23[1]) + (fTemp7 * fRec23[2]))) + (4.656612875245797e-10f * (((fRec24[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec23[0] = fVec9[(IOTA-41)&63];
			int iTemp14 = (fabsf((fTemp10 - 1)) < 0.5f);
			iVec10[0] = iTemp14;
			fRec27[0] = ((fRec27[1] + ((iVec10[0] - iVec10[1]) > 0.0f)) - (0.00296627625057368f * (fRec27[1] > 0.0f)));
			fVec11[IOTA&511] = ((0.4934425764844625f * ((fRec26[1] * fTemp6) + (fRec26[2] * fTemp7))) + (4.656612875245797e-10f * (fTemp9 * (fRec27[0] > 0.0f))));
			fRec26[0] = fVec11[(IOTA-336)&511];
			int iTemp15 = (fabsf((fTemp10 - 2)) < 0.5f);
			iVec12[0] = iTemp15;
			fRec29[0] = ((fRec29[1] + ((iVec12[0] - iVec12[1]) > 0.0f)) - (0.0033295325160703805f * (fRec29[1] > 0.0f)));
			fVec13[IOTA&511] = ((0.4941537998866976f * ((fTemp6 * fRec28[1]) + (fTemp7 * fRec28[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec29[0] > 0.0f))));
			fRec28[0] = fVec13[(IOTA-299)&511];
			int iTemp16 = (fabsf((fTemp10 - 3)) < 0.5f);
			iVec14[0] = iTemp16;
			fRec31[0] = ((fRec31[1] + ((iVec14[0] - iVec14[1]) > 0.0f)) - (0.00373727388790102f * (fRec31[1] > 0.0f)));
			fVec15[IOTA&511] = ((0.4947882913184981f * ((fTemp6 * fRec30[1]) + (fTemp7 * fRec30[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec31[0] > 0.0f))));
			fRec30[0] = fVec15[(IOTA-266)&511];
			int iTemp17 = (fabsf((fTemp10 - 4)) < 0.5f);
			iVec16[0] = iTemp17;
			fRec33[0] = ((fRec33[1] + ((iVec16[0] - iVec16[1]) > 0.0f)) - (0.004444392698205774f * (fRec33[1] > 0.0f)));
			fVec17[IOTA&255] = ((0.49561384415280396f * ((fTemp6 * fRec32[1]) + (fTemp7 * fRec32[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec33[0] > 0.0f))));
			fRec32[0] = fVec17[(IOTA-224)&255];
			int iTemp18 = (fabsf((fTemp10 - 5)) < 0.5f);
			iVec18[0] = iTemp18;
			fRec35[0] = ((fRec35[1] + ((iVec18[0] - iVec18[1]) > 0.0f)) - (0.004988662131519274f * (fRec35[1] > 0.0f)));
			fVec19[IOTA&255] = ((0.49609050335141536f * ((fTemp6 * fRec34[1]) + (fTemp7 * fRec34[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec35[0] > 0.0f))));
			fRec34[0] = fVec19[(IOTA-199)&255];
			int iTemp19 = (fabsf((fTemp10 - 6)) < 0.5f);
			iVec20[0] = iTemp19;
			fRec37[0] = ((fRec37[1] + ((iVec20[0] - iVec20[1]) > 0.0f)) - (0.00593255250114736f * (fRec37[1] > 0.0f)));
			fVec21[IOTA&255] = ((0.4967104672162962f * ((fTemp6 * fRec36[1]) + (fTemp7 * fRec36[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec37[0] > 0.0f))));
			fRec36[0] = fVec21[(IOTA-167)&255];
			int iTemp20 = (fabsf((fTemp10 - 7)) < 0.5f);
			iVec22[0] = iTemp20;
			fRec39[0] = ((fRec39[1] + ((iVec22[0] - iVec22[1]) > 0.0f)) - (0.006659065032140761f * (fRec39[1] > 0.0f)));
			fVec23[IOTA&255] = ((0.49706830510841143f * ((fTemp6 * fRec38[1]) + (fTemp7 * fRec38[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec39[0] > 0.0f))));
			fRec38[0] = fVec23[(IOTA-149)&255];
			int iTemp21 = (fabsf((fTemp10 - 8)) < 0.5f);
			iVec24[0] = iTemp21;
			fRec41[0] = ((fRec41[1] + ((iVec24[0] - iVec24[1]) > 0.0f)) - (0.00747454777580204f * (fRec41[1] > 0.0f)));
			fVec25[IOTA&255] = ((0.49738731956016835f * ((fTemp6 * fRec40[1]) + (fTemp7 * fRec40[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec41[0] > 0.0f))));
			fRec40[0] = fVec25[(IOTA-132)&255];
			int iTemp22 = (fabsf((fTemp10 - 9)) < 0.5f);
			iVec26[0] = iTemp22;
			fRec43[0] = ((fRec43[1] + ((iVec26[0] - iVec26[1]) > 0.0f)) - (0.008888785396411547f * (fRec43[1] > 0.0f)));
			fVec27[IOTA&127] = ((0.4978020912736325f * ((fTemp6 * fRec42[1]) + (fTemp7 * fRec42[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec43[0] > 0.0f))));
			fRec42[0] = fVec27[(IOTA-111)&127];
			int iTemp23 = (fabsf((fTemp10 - 10)) < 0.5f);
			iVec28[0] = iTemp23;
			fRec45[0] = ((fRec45[1] + ((iVec28[0] - iVec28[1]) > 0.0f)) - (0.009977324263038548f * (fRec45[1] > 0.0f)));
			fVec29[IOTA&127] = ((0.4980414156229456f * ((fTemp6 * fRec44[1]) + (fTemp7 * fRec44[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec45[0] > 0.0f))));
			fRec44[0] = fVec29[(IOTA-99)&127];
			int iTemp24 = (fabsf((fTemp12 - 1)) < 0.5f);
			iVec30[0] = iTemp24;
			fRec47[0] = ((fRec47[1] + ((iVec30[0] - iVec30[1]) > 0.0f)) - (0.00593255250114736f * (fRec47[1] > 0.0f)));
			fVec31[IOTA&255] = ((0.4967104672162962f * ((fTemp6 * fRec46[1]) + (fTemp7 * fRec46[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec47[0] > 0.0f))));
			fRec46[0] = fVec31[(IOTA-167)&255];
			int iTemp25 = (fabsf((fTemp12 - 2)) < 0.5f);
			iVec32[0] = iTemp25;
			fRec49[0] = ((fRec49[1] + ((iVec32[0] - iVec32[1]) > 0.0f)) - (0.006659065032140761f * (fRec49[1] > 0.0f)));
			fVec33[IOTA&255] = ((0.49706830510841143f * ((fTemp6 * fRec48[1]) + (fTemp7 * fRec48[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec49[0] > 0.0f))));
			fRec48[0] = fVec33[(IOTA-149)&255];
			int iTemp26 = (fabsf((fTemp12 - 3)) < 0.5f);
			iVec34[0] = iTemp26;
			fRec51[0] = ((fRec51[1] + ((iVec34[0] - iVec34[1]) > 0.0f)) - (0.00747454777580204f * (fRec51[1] > 0.0f)));
			fVec35[IOTA&255] = ((0.49738731956016835f * ((fTemp6 * fRec50[1]) + (fTemp7 * fRec50[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec51[0] > 0.0f))));
			fRec50[0] = fVec35[(IOTA-132)&255];
			int iTemp27 = (fabsf((fTemp12 - 4)) < 0.5f);
			iVec36[0] = iTemp27;
			fRec53[0] = ((fRec53[1] + ((iVec36[0] - iVec36[1]) > 0.0f)) - (0.008888785396411547f * (fRec53[1] > 0.0f)));
			fVec37[IOTA&127] = ((0.4978020912736325f * ((fTemp6 * fRec52[1]) + (fTemp7 * fRec52[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec53[0] > 0.0f))));
			fRec52[0] = fVec37[(IOTA-111)&127];
			int iTemp28 = (fabsf((fTemp12 - 5)) < 0.5f);
			iVec38[0] = iTemp28;
			fRec55[0] = ((fRec55[1] + ((iVec38[0] - iVec38[1]) > 0.0f)) - (0.009977324263038548f * (fRec55[1] > 0.0f)));
			fVec39[IOTA&127] = ((0.4980414156229456f * ((fTemp6 * fRec54[1]) + (fTemp7 * fRec54[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec55[0] > 0.0f))));
			fRec54[0] = fVec39[(IOTA-99)&127];
			int iTemp29 = (fabsf((fTemp12 - 6)) < 0.5f);
			iVec40[0] = iTemp29;
			fRec57[0] = ((fRec57[1] + ((iVec40[0] - iVec40[1]) > 0.0f)) - (0.01186510500229472f * (fRec57[1] > 0.0f)));
			fVec41[IOTA&127] = ((0.498352519415873f * ((fTemp6 * fRec56[1]) + (fTemp7 * fRec56[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec57[0] > 0.0f))));
			fRec56[0] = fVec41[(IOTA-83)&127];
			int iTemp30 = (fabsf((fTemp12 - 7)) < 0.5f);
			iVec42[0] = iTemp30;
			fRec59[0] = ((fRec59[1] + ((iVec42[0] - iVec42[1]) > 0.0f)) - (0.013318130064281522f * (fRec59[1] > 0.0f)));
			fVec43[IOTA&127] = ((0.49853199752293303f * ((fTemp6 * fRec58[1]) + (fTemp7 * fRec58[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec59[0] > 0.0f))));
			fRec58[0] = fVec43[(IOTA-74)&127];
			int iTemp31 = (fabsf((fTemp12 - 8)) < 0.5f);
			iVec44[0] = iTemp31;
			fRec61[0] = ((fRec61[1] + ((iVec44[0] - iVec44[1]) > 0.0f)) - (0.01494909555160408f * (fRec61[1] > 0.0f)));
			fVec45[IOTA&127] = ((0.49869194878209555f * ((fTemp6 * fRec60[1]) + (fTemp7 * fRec60[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec61[0] > 0.0f))));
			fRec60[0] = fVec45[(IOTA-65)&127];
			int iTemp32 = (fabsf((fTemp12 - 9)) < 0.5f);
			iVec46[0] = iTemp32;
			fRec63[0] = ((fRec63[1] + ((iVec46[0] - iVec46[1]) > 0.0f)) - (0.017777570792823095f * (fRec63[1] > 0.0f)));
			fVec47[IOTA&63] = ((0.4988998352743928f * ((fTemp6 * fRec62[1]) + (fTemp7 * fRec62[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec63[0] > 0.0f))));
			fRec62[0] = fVec47[(IOTA-55)&63];
			int iTemp33 = (fabsf((fTemp12 - 10)) < 0.5f);
			iVec48[0] = iTemp33;
			fRec65[0] = ((fRec65[1] + ((iVec48[0] - iVec48[1]) > 0.0f)) - (0.019954648526077097f * (fRec65[1] > 0.0f)));
			fVec49[IOTA&63] = ((0.4990197469153629f * ((fTemp6 * fRec64[1]) + (fTemp7 * fRec64[2]))) + (4.656612875245797e-10f * (fTemp9 * (fRec65[0] > 0.0f))));
			fRec64[0] = fVec49[(IOTA-49)&63];
			iVec50[0] = iSlow12;
			iRec68[0] = ((iTemp1)?0:(iRec68[1] + abs((iSlow12 - iVec50[1]))));
			ftbl5[((int((iVec0[0] & ((iRec68[0] > 0) | iSlow13))))?iRec4[0]:15)] = iSlow12;
			float fTemp34 = ftbl5[iRec4[0]];
			int iTemp35 = (fabsf((fTemp34 - 1)) < 0.5f);
			iVec51[0] = iTemp35;
			fRec67[0] = ((fRec67[1] + ((iVec51[0] - iVec51[1]) > 0.0f)) - (0.01186510500229472f * (fRec67[1] > 0.0f)));
			fVec52[IOTA&127] = ((0.498352519415873f * ((fTemp6 * fRec66[1]) + (fTemp7 * fRec66[2]))) + (4.656612875245797e-10f * (((fRec67[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec66[0] = fVec52[(IOTA-83)&127];
			int iTemp36 = (fabsf((fTemp34 - 2)) < 0.5f);
			iVec53[0] = iTemp36;
			fRec70[0] = ((fRec70[1] + ((iVec53[0] - iVec53[1]) > 0.0f)) - (0.013318130064281522f * (fRec70[1] > 0.0f)));
			fVec54[IOTA&127] = ((0.49853199752293303f * ((fTemp6 * fRec69[1]) + (fTemp7 * fRec69[2]))) + (4.656612875245797e-10f * (((fRec70[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec69[0] = fVec54[(IOTA-74)&127];
			int iTemp37 = (fabsf((fTemp34 - 3)) < 0.5f);
			iVec55[0] = iTemp37;
			fRec72[0] = ((fRec72[1] + ((iVec55[0] - iVec55[1]) > 0.0f)) - (0.01494909555160408f * (fRec72[1] > 0.0f)));
			fVec56[IOTA&127] = ((0.49869194878209555f * ((fTemp6 * fRec71[1]) + (fTemp7 * fRec71[2]))) + (4.656612875245797e-10f * (((fRec72[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec71[0] = fVec56[(IOTA-65)&127];
			int iTemp38 = (fabsf((fTemp34 - 4)) < 0.5f);
			iVec57[0] = iTemp38;
			fRec74[0] = ((fRec74[1] + ((iVec57[0] - iVec57[1]) > 0.0f)) - (0.017777570792823095f * (fRec74[1] > 0.0f)));
			fVec58[IOTA&63] = ((0.4988998352743928f * ((fTemp6 * fRec73[1]) + (fTemp7 * fRec73[2]))) + (4.656612875245797e-10f * (((fRec74[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec73[0] = fVec58[(IOTA-55)&63];
			int iTemp39 = (fabsf((fTemp34 - 5)) < 0.5f);
			iVec59[0] = iTemp39;
			fRec76[0] = ((fRec76[1] + ((iVec59[0] - iVec59[1]) > 0.0f)) - (0.019954648526077097f * (fRec76[1] > 0.0f)));
			fVec60[IOTA&63] = ((0.4990197469153629f * ((fTemp6 * fRec75[1]) + (fTemp7 * fRec75[2]))) + (4.656612875245797e-10f * (((fRec76[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec75[0] = fVec60[(IOTA-49)&63];
			int iTemp40 = (fabsf((fTemp34 - 6)) < 0.5f);
			iVec61[0] = iTemp40;
			fRec78[0] = ((fRec78[1] + ((iVec61[0] - iVec61[1]) > 0.0f)) - (0.02373021000458944f * (fRec78[1] > 0.0f)));
			fVec62[IOTA&63] = ((0.4991755800396655f * ((fTemp6 * fRec77[1]) + (fTemp7 * fRec77[2]))) + (4.656612875245797e-10f * (((fRec78[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec77[0] = fVec62[(IOTA-41)&63];
			float fTemp41 = (0.7071067811865476f * fRec77[0]);
			int iTemp42 = (fabsf((fTemp34 - 7)) < 0.5f);
			iVec63[0] = iTemp42;
			fRec80[0] = ((fRec80[1] + ((iVec63[0] - iVec63[1]) > 0.0f)) - (0.026636260128563044f * (fRec80[1] > 0.0f)));
			fVec64[IOTA&63] = ((0.4992654592112963f * ((fTemp6 * fRec79[1]) + (fTemp7 * fRec79[2]))) + (4.656612875245797e-10f * (((fRec80[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec79[0] = fVec64[(IOTA-36)&63];
			int iTemp43 = (fabsf((fTemp34 - 8)) < 0.5f);
			iVec65[0] = iTemp43;
			fRec82[0] = ((fRec82[1] + ((iVec65[0] - iVec65[1]) > 0.0f)) - (0.02989819110320816f * (fRec82[1] > 0.0f)));
			fVec66[IOTA&63] = ((0.4993455460811158f * ((fTemp6 * fRec81[1]) + (fTemp7 * fRec81[2]))) + (4.656612875245797e-10f * (((fRec82[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec81[0] = fVec66[(IOTA-32)&63];
			int iTemp44 = (fabsf((fTemp34 - 9)) < 0.5f);
			iVec67[0] = iTemp44;
			fRec84[0] = ((fRec84[1] + ((iVec67[0] - iVec67[1]) > 0.0f)) - (0.03555514158564619f * (fRec84[1] > 0.0f)));
			fVec68[IOTA&31] = ((0.4994496147132325f * ((fTemp6 * fRec83[1]) + (fTemp7 * fRec83[2]))) + (4.656612875245797e-10f * (((fRec84[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec83[0] = fVec68[(IOTA-27)&31];
			int iTemp45 = (fabsf((fTemp34 - 10)) < 0.5f);
			iVec69[0] = iTemp45;
			fRec86[0] = ((fRec86[1] + ((iVec69[0] - iVec69[1]) > 0.0f)) - (0.039909297052154194f * (fRec86[1] > 0.0f)));
			fVec70[IOTA&31] = ((0.49950963299788465f * ((fTemp6 * fRec85[1]) + (fTemp7 * fRec85[2]))) + (4.656612875245797e-10f * (((fRec86[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec85[0] = fVec70[(IOTA-24)&31];
			int iTemp46 = (fabsf((fTemp34 - 11)) < 0.5f);
			iVec71[0] = iTemp46;
			fRec88[0] = ((fRec88[1] + ((iVec71[0] - iVec71[1]) > 0.0f)) - (0.04746042000917888f * (fRec88[1] > 0.0f)));
			fVec72[IOTA&31] = ((0.4995876199625375f * ((fTemp6 * fRec87[1]) + (fTemp7 * fRec87[2]))) + (4.656612875245797e-10f * (((fRec88[0] > 0.0f) * fTemp8) * iRec20[0])));
			fRec87[0] = fVec72[(IOTA-20)&31];
			float fTemp47 = ((0.21320071635561033f * (((((((((((fRec17[0] + ((((((((((fRec23[0] + (4.5825756949558425f * fRec26[0])) + (4.358898943540676f * fRec28[0])) + (4.123105625617662f * fRec30[0])) + (3.872983346207419f * fRec32[0])) + (3.6055512754639905f * fRec34[0])) + (3.3166247903554016f * fRec36[0])) + (3.0000000000000018f * fRec38[0])) + (2.645751311064592f * fRec40[0])) + (2.2360679774997907f * fRec42[0])) + (1.732050807568878f * fRec44[0]))) + (4.5825756949558425f * fRec46[0])) + (4.358898943540676f * fRec48[0])) + (4.123105625617662f * fRec50[0])) + (3.872983346207419f * fRec52[0])) + (3.6055512754639905f * fRec54[0])) + (3.3166247903554016f * fRec56[0])) + (3.0000000000000018f * fRec58[0])) + (2.645751311064592f * fRec60[0])) + (2.2360679774997907f * fRec62[0])) + (1.732050807568878f * fRec64[0]))) + (1.5f * (((((((((((0.9770084209183945f * fRec66[0]) + (0.9293203772845852f * fRec69[0])) + (0.8790490729915326f * fRec71[0])) + (0.8257228238447705f * fRec73[0])) + (0.7687061147858073f * fRec75[0])) + fTemp41) + (0.6396021490668313f * fRec79[0])) + (0.5640760748177662f * fRec81[0])) + (0.4767312946227962f * fRec83[0])) + (0.3692744729379982f * fRec85[0])) + (0.21320071635561033f * fRec87[0]))));
			float fTemp48 = ((1.5f * ((((((fTemp41 + ((((0.4767312946227962f * fRec71[0]) + ((0.3692744729379982f * fRec69[0]) + (0.21320071635561044f * fRec66[0]))) + (0.5640760748177662f * fRec73[0])) + (0.6396021490668313f * fRec75[0]))) + (0.7687061147858074f * fRec79[0])) + (0.8257228238447705f * fRec81[0])) + (0.8790490729915326f * fRec83[0])) + (0.9293203772845852f * fRec85[0])) + (0.9770084209183945f * fRec87[0]))) + (0.9770084209183945f * (((((((((((fRec17[0] + ((((((((((fRec23[0] + (0.2182178902359924f * fRec26[0])) + (0.3779644730092272f * fRec28[0])) + (0.4879500364742666f * fRec30[0])) + (0.5773502691896257f * fRec32[0])) + (0.6546536707079771f * fRec34[0])) + (0.7237468644557459f * fRec36[0])) + (0.7867957924694431f * fRec38[0])) + (0.8451542547285166f * fRec40[0])) + (0.8997354108424374f * fRec42[0])) + (0.9511897312113419f * fRec44[0]))) + (0.2182178902359924f * fRec46[0])) + (0.3779644730092272f * fRec48[0])) + (0.4879500364742666f * fRec50[0])) + (0.5773502691896257f * fRec52[0])) + (0.6546536707079771f * fRec54[0])) + (0.7237468644557459f * fRec56[0])) + (0.7867957924694431f * fRec58[0])) + (0.8451542547285166f * fRec60[0])) + (0.8997354108424374f * fRec62[0])) + (0.9511897312113419f * fRec64[0]))));
			float fTemp49 = (0.015f * (fTemp47 + fTemp48));
			fVec73[IOTA&2047] = ((0.9239999999999999f * fRec16[0]) + fTemp49);
			fRec15[0] = fVec73[(IOTA-1116)&2047];
			fRec90[0] = ((0.30000000000000004f * fRec90[1]) + (0.7f * fRec89[1]));
			fVec74[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec90[0]));
			fRec89[0] = fVec74[(IOTA-1188)&2047];
			fRec92[0] = ((0.30000000000000004f * fRec92[1]) + (0.7f * fRec91[1]));
			fVec75[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec92[0]));
			fRec91[0] = fVec75[(IOTA-1277)&2047];
			fRec94[0] = ((0.30000000000000004f * fRec94[1]) + (0.7f * fRec93[1]));
			fVec76[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec94[0]));
			fRec93[0] = fVec76[(IOTA-1356)&2047];
			fRec96[0] = ((0.30000000000000004f * fRec96[1]) + (0.7f * fRec95[1]));
			fVec77[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec96[0]));
			fRec95[0] = fVec77[(IOTA-1422)&2047];
			fRec98[0] = ((0.30000000000000004f * fRec98[1]) + (0.7f * fRec97[1]));
			fVec78[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec98[0]));
			fRec97[0] = fVec78[(IOTA-1491)&2047];
			fRec100[0] = ((0.30000000000000004f * fRec100[1]) + (0.7f * fRec99[1]));
			fVec79[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec100[0]));
			fRec99[0] = fVec79[(IOTA-1557)&2047];
			fRec102[0] = ((0.30000000000000004f * fRec102[1]) + (0.7f * fRec101[1]));
			fVec80[IOTA&2047] = (fTemp49 + (0.9239999999999999f * fRec102[0]));
			fRec101[0] = fVec80[(IOTA-1617)&2047];
			float fTemp50 = (((((((fRec15[0] + fRec89[0]) + fRec91[0]) + fRec93[0]) + fRec95[0]) + fRec97[0]) + fRec99[0]) + fRec101[0]);
			fVec81[IOTA&1023] = (fTemp50 + (0.5f * fRec13[1]));
			fRec13[0] = fVec81[(IOTA-556)&1023];
			float 	fRec14 = (0 - (fTemp50 - fRec13[1]));
			...
			fRec103[0] = (0 - (((fRec1[0] * fRec103[1]) + (fRec5[0] * fRec103[2])) - (fRec6[0] * ((fSlow3 * fRec105) + (fSlow14 * fTemp48)))));
	...
	FAUST_ADDVERTICALSLIDER("kisanaWD/Loops/loop/level", fslider4, 0.0f, 0.0f, 6.0f, 1.0f);
	FAUST_ADDVERTICALSLIDER("kisanaWD/Loops/loop48/note", fslider5, 0.0f, 0.0f, 11.0f, 1.0f);
	FAUST_ADDVERTICALSLIDER("kisanaWD/Loops/loop60/note", fslider6, 0.0f, 0.0f, 11.0f, 1.0f);
