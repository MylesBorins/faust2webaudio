...
class Noise : public dsp {
  ...
  public:
	...
	virtual void instanceInit(int samplingFreq) {
		...
		for (int i=0; i<256; i++) fVec34[i] = 0;
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalSlider("level", &fslider2, 0.0f, 0.0f, 6.0f, 1.0f);
		interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			iRec3[0] = ((iRec3[1] + iVec0[0]) % 15);
			ftbl0[((int((iVec0[0] & ((fRec2[0] > 0) | iSlow2))))?iRec3[0]:15)] = fSlow1;
			float fTemp2 = ftbl0[iRec3[0]];
			float fTemp3 = (1 + fTemp2);
			float fTemp4 = (1 - fTemp2);
			iVec2[0] = iSlow3;
			iRec4[0] = ((iTemp1)?0:(iRec4[1] + abs((iSlow3 - iVec2[1]))));
			ftbl1[((int((iVec0[0] & ((iRec4[0] > 0) | iSlow4))))?iRec3[0]:15)] = iSlow3;
			float fTemp5 = powf(10,(0.05f * (ftbl1[iRec3[0]] - 6)));
			iRec5[0] = (12345 + (1103515245 * iRec5[1]));
			float fTemp6 = (fTemp5 * iRec5[0]);
			iVec3[0] = iSlow5;
			iRec7[0] = ((iTemp1)?0:(iRec7[1] + abs((iSlow5 - iVec3[1]))));
			ftbl2[((int((iVec0[0] & ((iRec7[0] > 0) | iSlow6))))?iRec3[0]:15)] = iSlow5;
			float fTemp7 = ftbl2[iRec3[0]];
			int iTemp8 = (fabsf((fTemp7 - 4)) < 0.5f);
			iVec4[0] = iTemp8;
			fRec6[0] = ((fRec6[1] + ((iVec4[0] - iVec4[1]) > 0.0f)) - (0.008888785396411547f * (fRec6[1] > 0.0f)));
			fVec5[IOTA&127] = ((0.4978020912736325f * ((fTemp3 * fRec0[1]) + (fTemp4 * fRec0[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec6[0] > 0.0f))));
			fRec0[0] = fVec5[(IOTA-111)&127];
			iVec6[0] = iSlow7;
			iRec10[0] = ((iTemp1)?0:(iRec10[1] + abs((iSlow7 - iVec6[1]))));
			ftbl3[((int((iVec0[0] & ((iRec10[0] > 0) | iSlow8))))?iRec3[0]:15)] = iSlow7;
			float fTemp9 = ftbl3[iRec3[0]];
			int iTemp10 = (fabsf((fTemp9 - 2)) < 0.5f);
			iVec7[0] = iTemp10;
			fRec9[0] = ((fRec9[1] + ((iVec7[0] - iVec7[1]) > 0.0f)) - (0.0033295325160703805f * (fRec9[1] > 0.0f)));
			fVec8[IOTA&511] = ((0.4941537998866976f * ((fTemp3 * fRec8[1]) + (fTemp4 * fRec8[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec9[0] > 0.0f))));
			fRec8[0] = fVec8[(IOTA-299)&511];
			int iTemp11 = (fabsf((fTemp9 - 1)) < 0.5f);
			iVec9[0] = iTemp11;
			fRec12[0] = ((fRec12[1] + ((iVec9[0] - iVec9[1]) > 0.0f)) - (0.00296627625057368f * (fRec12[1] > 0.0f)));
			fVec10[IOTA&511] = ((0.4934425764844625f * ((fRec11[1] * fTemp3) + (fRec11[2] * fTemp4))) + (4.656612875245797e-10f * (fTemp6 * (fRec12[0] > 0.0f))));
			fRec11[0] = fVec10[(IOTA-336)&511];
			int iTemp12 = (fabsf((fTemp9 - 3)) < 0.5f);
			iVec11[0] = iTemp12;
			fRec14[0] = ((fRec14[1] + ((iVec11[0] - iVec11[1]) > 0.0f)) - (0.00373727388790102f * (fRec14[1] > 0.0f)));
			fVec12[IOTA&511] = ((0.4947882913184981f * ((fTemp3 * fRec13[1]) + (fTemp4 * fRec13[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec14[0] > 0.0f))));
			fRec13[0] = fVec12[(IOTA-266)&511];
			int iTemp13 = (fabsf((fTemp9 - 4)) < 0.5f);
			iVec13[0] = iTemp13;
			fRec16[0] = ((fRec16[1] + ((iVec13[0] - iVec13[1]) > 0.0f)) - (0.004444392698205774f * (fRec16[1] > 0.0f)));
			fVec14[IOTA&255] = ((0.49561384415280396f * ((fTemp3 * fRec15[1]) + (fTemp4 * fRec15[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec16[0] > 0.0f))));
			fRec15[0] = fVec14[(IOTA-224)&255];
			int iTemp14 = (fabsf((fTemp9 - 5)) < 0.5f);
			iVec15[0] = iTemp14;
			fRec18[0] = ((fRec18[1] + ((iVec15[0] - iVec15[1]) > 0.0f)) - (0.004988662131519274f * (fRec18[1] > 0.0f)));
			fVec16[IOTA&255] = ((0.49609050335141536f * ((fTemp3 * fRec17[1]) + (fTemp4 * fRec17[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec18[0] > 0.0f))));
			fRec17[0] = fVec16[(IOTA-199)&255];
			int iTemp15 = (fabsf((fTemp9 - 6)) < 0.5f);
			iVec17[0] = iTemp15;
			fRec20[0] = ((fRec20[1] + ((iVec17[0] - iVec17[1]) > 0.0f)) - (0.00593255250114736f * (fRec20[1] > 0.0f)));
			fVec18[IOTA&255] = ((0.4967104672162962f * ((fTemp3 * fRec19[1]) + (fTemp4 * fRec19[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec20[0] > 0.0f))));
			fRec19[0] = fVec18[(IOTA-167)&255];
			int iTemp16 = (fabsf((fTemp9 - 7)) < 0.5f);
			iVec19[0] = iTemp16;
			fRec22[0] = ((fRec22[1] + ((iVec19[0] - iVec19[1]) > 0.0f)) - (0.006659065032140761f * (fRec22[1] > 0.0f)));
			fVec20[IOTA&255] = ((0.49706830510841143f * ((fTemp3 * fRec21[1]) + (fTemp4 * fRec21[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec22[0] > 0.0f))));
			fRec21[0] = fVec20[(IOTA-149)&255];
			int iTemp17 = (fabsf((fTemp9 - 8)) < 0.5f);
			iVec21[0] = iTemp17;
			fRec24[0] = ((fRec24[1] + ((iVec21[0] - iVec21[1]) > 0.0f)) - (0.00747454777580204f * (fRec24[1] > 0.0f)));
			fVec22[IOTA&255] = ((0.49738731956016835f * ((fTemp3 * fRec23[1]) + (fTemp4 * fRec23[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec24[0] > 0.0f))));
			fRec23[0] = fVec22[(IOTA-132)&255];
			int iTemp18 = (fabsf((fTemp9 - 9)) < 0.5f);
			iVec23[0] = iTemp18;
			fRec26[0] = ((fRec26[1] + ((iVec23[0] - iVec23[1]) > 0.0f)) - (0.008888785396411547f * (fRec26[1] > 0.0f)));
			fVec24[IOTA&127] = ((0.4978020912736325f * ((fTemp3 * fRec25[1]) + (fTemp4 * fRec25[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec26[0] > 0.0f))));
			fRec25[0] = fVec24[(IOTA-111)&127];
			int iTemp19 = (fabsf((fTemp9 - 10)) < 0.5f);
			iVec25[0] = iTemp19;
			fRec28[0] = ((fRec28[1] + ((iVec25[0] - iVec25[1]) > 0.0f)) - (0.009977324263038548f * (fRec28[1] > 0.0f)));
			fVec26[IOTA&127] = ((0.4980414156229456f * ((fTemp3 * fRec27[1]) + (fTemp4 * fRec27[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec28[0] > 0.0f))));
			fRec27[0] = fVec26[(IOTA-99)&127];
			int iTemp20 = (fabsf((fTemp9 - 11)) < 0.5f);
			iVec27[0] = iTemp20;
			fRec30[0] = ((fRec30[1] + ((iVec27[0] - iVec27[1]) > 0.0f)) - (0.01186510500229472f * (fRec30[1] > 0.0f)));
			fVec28[IOTA&127] = ((0.498352519415873f * ((fTemp3 * fRec29[1]) + (fTemp4 * fRec29[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec30[0] > 0.0f))));
			fRec29[0] = fVec28[(IOTA-83)&127];
			int iTemp21 = (fabsf((fTemp7 - 1)) < 0.5f);
			iVec29[0] = iTemp21;
			fRec32[0] = ((fRec32[1] + ((iVec29[0] - iVec29[1]) > 0.0f)) - (0.00593255250114736f * (fRec32[1] > 0.0f)));
			fVec30[IOTA&255] = ((0.4967104672162962f * ((fTemp3 * fRec31[1]) + (fTemp4 * fRec31[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec32[0] > 0.0f))));
			fRec31[0] = fVec30[(IOTA-167)&255];
			int iTemp22 = (fabsf((fTemp7 - 2)) < 0.5f);
			iVec31[0] = iTemp22;
			fRec34[0] = ((fRec34[1] + ((iVec31[0] - iVec31[1]) > 0.0f)) - (0.006659065032140761f * (fRec34[1] > 0.0f)));
			fVec32[IOTA&255] = ((0.49706830510841143f * ((fTemp3 * fRec33[1]) + (fTemp4 * fRec33[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec34[0] > 0.0f))));
			fRec33[0] = fVec32[(IOTA-149)&255];
			int iTemp23 = (fabsf((fTemp7 - 3)) < 0.5f);
			iVec33[0] = iTemp23;
			fRec36[0] = ((fRec36[1] + ((iVec33[0] - iVec33[1]) > 0.0f)) - (0.00747454777580204f * (fRec36[1] > 0.0f)));
			fVec34[IOTA&255] = ((0.49738731956016835f * ((fTemp3 * fRec35[1]) + (fTemp4 * fRec35[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec36[0] > 0.0f))));
			fRec35[0] = fVec34[(IOTA-132)&255];
			int iTemp24 = (fabsf((fTemp7 - 5)) < 0.5f);
			iVec35[0] = iTemp24;
			fRec38[0] = ((fRec38[1] + ((iVec35[0] - iVec35[1]) > 0.0f)) - (0.009977324263038548f * (fRec38[1] > 0.0f)));
			fVec36[IOTA&127] = ((0.4980414156229456f * ((fTemp3 * fRec37[1]) + (fTemp4 * fRec37[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec38[0] > 0.0f))));
			fRec37[0] = fVec36[(IOTA-99)&127];
			int iTemp25 = (fabsf((fTemp7 - 6)) < 0.5f);
			iVec37[0] = iTemp25;
			fRec40[0] = ((fRec40[1] + ((iVec37[0] - iVec37[1]) > 0.0f)) - (0.01186510500229472f * (fRec40[1] > 0.0f)));
			fVec38[IOTA&127] = ((0.498352519415873f * ((fTemp3 * fRec39[1]) + (fTemp4 * fRec39[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec40[0] > 0.0f))));
			fRec39[0] = fVec38[(IOTA-83)&127];
			int iTemp26 = (fabsf((fTemp7 - 7)) < 0.5f);
			iVec39[0] = iTemp26;
			fRec42[0] = ((fRec42[1] + ((iVec39[0] - iVec39[1]) > 0.0f)) - (0.013318130064281522f * (fRec42[1] > 0.0f)));
			fVec40[IOTA&127] = ((0.49853199752293303f * ((fTemp3 * fRec41[1]) + (fTemp4 * fRec41[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec42[0] > 0.0f))));
			fRec41[0] = fVec40[(IOTA-74)&127];
			int iTemp27 = (fabsf((fTemp7 - 8)) < 0.5f);
			iVec41[0] = iTemp27;
			fRec44[0] = ((fRec44[1] + ((iVec41[0] - iVec41[1]) > 0.0f)) - (0.01494909555160408f * (fRec44[1] > 0.0f)));
			fVec42[IOTA&127] = ((0.49869194878209555f * ((fTemp3 * fRec43[1]) + (fTemp4 * fRec43[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec44[0] > 0.0f))));
			fRec43[0] = fVec42[(IOTA-65)&127];
			int iTemp28 = (fabsf((fTemp7 - 9)) < 0.5f);
			iVec43[0] = iTemp28;
			fRec46[0] = ((fRec46[1] + ((iVec43[0] - iVec43[1]) > 0.0f)) - (0.017777570792823095f * (fRec46[1] > 0.0f)));
			fVec44[IOTA&63] = ((0.4988998352743928f * ((fTemp3 * fRec45[1]) + (fTemp4 * fRec45[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec46[0] > 0.0f))));
			fRec45[0] = fVec44[(IOTA-55)&63];
			int iTemp29 = (fabsf((fTemp7 - 10)) < 0.5f);
			iVec45[0] = iTemp29;
			fRec48[0] = ((fRec48[1] + ((iVec45[0] - iVec45[1]) > 0.0f)) - (0.019954648526077097f * (fRec48[1] > 0.0f)));
			fVec46[IOTA&63] = ((0.4990197469153629f * ((fTemp3 * fRec47[1]) + (fTemp4 * fRec47[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec48[0] > 0.0f))));
			fRec47[0] = fVec46[(IOTA-49)&63];
			int iTemp30 = (fabsf((fTemp7 - 11)) < 0.5f);
			iVec47[0] = iTemp30;
			fRec50[0] = ((fRec50[1] + ((iVec47[0] - iVec47[1]) > 0.0f)) - (0.02373021000458944f * (fRec50[1] > 0.0f)));
			fVec48[IOTA&63] = ((0.4991755800396655f * ((fTemp3 * fRec49[1]) + (fTemp4 * fRec49[2]))) + (4.656612875245797e-10f * (fTemp6 * (fRec50[0] > 0.0f))));
			...
			float fTemp31 = ftbl4[iRec3[0]];
			int iTemp32 = (fabsf((fTemp31 - 1)) < 0.5f);
			iVec50[0] = iTemp32;
			fRec52[0] = ((fRec52[1] + ((iVec50[0] - iVec50[1]) > 0.0f)) - (0.01186510500229472f * (fRec52[1] > 0.0f)));
			fVec51[IOTA&127] = ((0.498352519415873f * ((fRec51[1] * fTemp3) + (fRec51[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec52[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec51[0] = fVec51[(IOTA-83)&127];
			int iTemp33 = (fabsf((fTemp31 - 2)) < 0.5f);
			iVec52[0] = iTemp33;
			fRec55[0] = ((fRec55[1] + ((iVec52[0] - iVec52[1]) > 0.0f)) - (0.013318130064281522f * (fRec55[1] > 0.0f)));
			fVec53[IOTA&127] = ((0.49853199752293303f * ((fRec54[1] * fTemp3) + (fRec54[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec55[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec54[0] = fVec53[(IOTA-74)&127];
			int iTemp34 = (fabsf((fTemp31 - 3)) < 0.5f);
			iVec54[0] = iTemp34;
			fRec57[0] = ((fRec57[1] + ((iVec54[0] - iVec54[1]) > 0.0f)) - (0.01494909555160408f * (fRec57[1] > 0.0f)));
			fVec55[IOTA&127] = ((0.49869194878209555f * ((fRec56[1] * fTemp3) + (fRec56[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec57[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec56[0] = fVec55[(IOTA-65)&127];
			int iTemp35 = (fabsf((fTemp31 - 4)) < 0.5f);
			iVec56[0] = iTemp35;
			fRec59[0] = ((fRec59[1] + ((iVec56[0] - iVec56[1]) > 0.0f)) - (0.017777570792823095f * (fRec59[1] > 0.0f)));
			fVec57[IOTA&63] = ((0.4988998352743928f * ((fRec58[1] * fTemp3) + (fRec58[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec59[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec58[0] = fVec57[(IOTA-55)&63];
			int iTemp36 = (fabsf((fTemp31 - 5)) < 0.5f);
			iVec58[0] = iTemp36;
			fRec61[0] = ((fRec61[1] + ((iVec58[0] - iVec58[1]) > 0.0f)) - (0.019954648526077097f * (fRec61[1] > 0.0f)));
			fVec59[IOTA&63] = ((0.4990197469153629f * ((fRec60[1] * fTemp3) + (fRec60[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec61[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec60[0] = fVec59[(IOTA-49)&63];
			int iTemp37 = (fabsf((fTemp31 - 6)) < 0.5f);
			iVec60[0] = iTemp37;
			fRec63[0] = ((fRec63[1] + ((iVec60[0] - iVec60[1]) > 0.0f)) - (0.02373021000458944f * (fRec63[1] > 0.0f)));
			fVec61[IOTA&63] = ((0.4991755800396655f * ((fRec62[1] * fTemp3) + (fRec62[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec63[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec62[0] = fVec61[(IOTA-41)&63];
			float fTemp38 = (0.7071067811865476f * fRec62[0]);
			int iTemp39 = (fabsf((fTemp31 - 7)) < 0.5f);
			iVec62[0] = iTemp39;
			fRec65[0] = ((fRec65[1] + ((iVec62[0] - iVec62[1]) > 0.0f)) - (0.026636260128563044f * (fRec65[1] > 0.0f)));
			fVec63[IOTA&63] = ((0.4992654592112963f * ((fRec64[1] * fTemp3) + (fRec64[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec65[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec64[0] = fVec63[(IOTA-36)&63];
			int iTemp40 = (fabsf((fTemp31 - 8)) < 0.5f);
			iVec64[0] = iTemp40;
			fRec67[0] = ((fRec67[1] + ((iVec64[0] - iVec64[1]) > 0.0f)) - (0.02989819110320816f * (fRec67[1] > 0.0f)));
			fVec65[IOTA&63] = ((0.4993455460811158f * ((fRec66[1] * fTemp3) + (fRec66[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec67[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec66[0] = fVec65[(IOTA-32)&63];
			int iTemp41 = (fabsf((fTemp31 - 9)) < 0.5f);
			iVec66[0] = iTemp41;
			fRec69[0] = ((fRec69[1] + ((iVec66[0] - iVec66[1]) > 0.0f)) - (0.03555514158564619f * (fRec69[1] > 0.0f)));
			fVec67[IOTA&31] = ((0.4994496147132325f * ((fRec68[2] * fTemp4) + (fRec68[1] * fTemp3))) + (4.656612875245797e-10f * (((fRec69[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec68[0] = fVec67[(IOTA-27)&31];
			int iTemp42 = (fabsf((fTemp31 - 10)) < 0.5f);
			iVec68[0] = iTemp42;
			fRec71[0] = ((fRec71[1] + ((iVec68[0] - iVec68[1]) > 0.0f)) - (0.039909297052154194f * (fRec71[1] > 0.0f)));
			fVec69[IOTA&31] = ((0.49950963299788465f * ((fRec70[1] * fTemp3) + (fRec70[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec71[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec70[0] = fVec69[(IOTA-24)&31];
			int iTemp43 = (fabsf((fTemp31 - 11)) < 0.5f);
			iVec70[0] = iTemp43;
			fRec73[0] = ((fRec73[1] + ((iVec70[0] - iVec70[1]) > 0.0f)) - (0.04746042000917888f * (fRec73[1] > 0.0f)));
			fVec71[IOTA&31] = ((0.4995876199625375f * ((fRec72[1] * fTemp3) + (fRec72[2] * fTemp4))) + (4.656612875245797e-10f * (((fRec73[0] > 0.0f) * fTemp5) * iRec5[0])));
			fRec72[0] = fVec71[(IOTA-20)&31];
			output0[i] = (FAUSTFLOAT)(fSlow0 * ((0.9770084209183945f * (((((((((0.8451542547285166f * fRec0[0]) + ((((((((((((((0.9511897312113419f * fRec8[0]) + fRec11[0]) + (0.8997354108424374f * fRec13[0])) + (0.8451542547285166f * fRec15[0])) + (0.786795792469443f * fRec17[0])) + (0.7237468644557459f * fRec19[0])) + (0.6546536707079771f * fRec21[0])) + (0.5773502691896257f * fRec23[0])) + (0.4879500364742666f * fRec25[0])) + (0.3779644730092272f * fRec27[0])) + (0.21821789023599225f * fRec29[0])) + fRec31[0]) + (0.9511897312113419f * fRec33[0])) + (0.8997354108424374f * fRec35[0]))) + (0.786795792469443f * fRec37[0])) + (0.7237468644557459f * fRec39[0])) + (0.6546536707079771f * fRec41[0])) + (0.5773502691896257f * fRec43[0])) + (0.4879500364742666f * fRec45[0])) + (0.3779644730092272f * fRec47[0])) + (0.21821789023599225f * fRec49[0]))) + (1.5f * (((((((((((0.9770084209183945f * fRec51[0]) + (0.9293203772845852f * fRec54[0])) + (0.8790490729915326f * fRec56[0])) + (0.8257228238447705f * fRec58[0])) + (0.7687061147858073f * fRec60[0])) + fTemp38) + (0.6396021490668313f * fRec64[0])) + (0.5640760748177662f * fRec66[0])) + (0.4767312946227962f * fRec68[0])) + (0.3692744729379982f * fRec70[0])) + (0.21320071635561033f * fRec72[0])))));
			output1[i] = (FAUSTFLOAT)(fSlow0 * ((1.5f * ((((((fTemp38 + (((0.5640760748177662f * fRec58[0]) + ((0.4767312946227962f * fRec56[0]) + ((0.3692744729379982f * fRec54[0]) + (0.21320071635561044f * fRec51[0])))) + (0.6396021490668313f * fRec60[0]))) + (0.7687061147858074f * fRec64[0])) + (0.8257228238447705f * fRec66[0])) + (0.8790490729915326f * fRec68[0])) + (0.9293203772845852f * fRec70[0])) + (0.9770084209183945f * fRec72[0]))) + (0.21320071635561044f * ((((((((((((((((((((((1.7320508075688772f * fRec8[0]) + fRec11[0]) + (2.23606797749979f * fRec13[0])) + (2.6457513110645907f * fRec15[0])) + (3.0f * fRec17[0])) + (3.3166247903554f * fRec19[0])) + (3.605551275463989f * fRec21[0])) + (3.872983346207417f * fRec23[0])) + (4.123105625617661f * fRec25[0])) + (4.358898943540674f * fRec27[0])) + (4.58257569495584f * fRec29[0])) + fRec31[0]) + (1.7320508075688772f * fRec33[0])) + (2.23606797749979f * fRec35[0])) + (2.6457513110645907f * fRec0[0])) + (3.0f * fRec37[0])) + (3.3166247903554f * fRec39[0])) + (3.605551275463989f * fRec41[0])) + (3.872983346207417f * fRec43[0])) + (4.123105625617661f * fRec45[0])) + (4.358898943540674f * fRec47[0])) + (4.58257569495584f * fRec49[0])))));
			// post processing
	...
	FAUST_ADDVERTICALSLIDER("kisana/Loops/loop/level", fslider2, 0.0f, 0.0f, 6.0f, 1.0f);
	FAUST_ADDVERTICALSLIDER("kisana/Loops/loop48/note", fslider4, 0.0f, 0.0f, 11.0f, 1.0f);
	FAUST_ADDVERTICALSLIDER("kisana/Loops/loop60/note", fslider3, 0.0f, 0.0f, 11.0f, 1.0f);
